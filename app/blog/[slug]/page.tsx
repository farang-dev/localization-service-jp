    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 pt-24">
        ...
        <article>
          ...
          />
          <div 
            className="prose prose-headings:font-bold prose-h1:text-2xl prose-h2:text-xl prose-h3:text-lg prose-ul:list-disc prose-ol:list-decimal max-w-none notion-content"
